...
public class PolygonPatchTypeType
    extends AbstractSurfacePatchTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "exterior", namespace = "http://www.opengis.net/gml/3.2", type = Exterior.class, required = false)
    protected Exterior exterior;
    @XmlElementRef(name = "interior", namespace = "http://www.opengis.net/gml/3.2", type = Interior.class, required = false)
    protected List<Interior> interior;
    ...
    public List<Interior> getInterior() {
        if (interior == null) {
            interior = new ArrayList<Interior>();
        }
