...
public class TimeTopologyComplexPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TimeTopologyComplex", namespace = "http://www.opengis.net/gml/3.2", type = TimeTopologyComplex.class, required = false)
    protected TimeTopologyComplex timeTopologyComplex;
     ...
     *     
     */
    public TimeTopologyComplex getTimeTopologyComplex() {
     ...
     *     
     */
    public void setTimeTopologyComplex(TimeTopologyComplex value) {
