...
public class MultiSolidPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "MultiSolid", namespace = "http://www.opengis.net/gml/3.2", type = MultiSolid.class, required = false)
    protected MultiSolid multiSolid;
     ...
     *     
     */
    public void setMultiSolid(MultiSolid value) {
