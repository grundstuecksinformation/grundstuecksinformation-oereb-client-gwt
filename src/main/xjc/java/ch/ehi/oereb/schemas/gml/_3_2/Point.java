...
public class Point
    extends JAXBElement<PointTypeType>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "Point");

    public Point(PointTypeType value) {
        super(NAME, ((Class) PointTypeType.class), null, value);
    }

    public Point() {
        super(NAME, ((Class) PointTypeType.class), null, null);
    }
