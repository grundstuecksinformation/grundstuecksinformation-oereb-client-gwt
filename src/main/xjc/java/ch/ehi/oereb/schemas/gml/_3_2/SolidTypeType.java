...
public class SolidTypeType
    extends AbstractSolidTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    protected ShellPropertyTypeType exterior;
    protected List<ShellPropertyTypeType> interior;
     ...
     * @return
     *     possible object is
     *     {@link ShellPropertyTypeType }
     *     
     */
    public ShellPropertyTypeType getExterior() {
        return exterior;
    }
     ...
     *     
     */
    public void setExterior(ShellPropertyTypeType value) {
        this.exterior = value;
    }
     ...
     * 
     */
    public List<ShellPropertyTypeType> getInterior() {
        if (interior == null) {
            interior = new ArrayList<ShellPropertyTypeType>();
        }
