...
public class OperationMethodPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "OperationMethod", namespace = "http://www.opengis.net/gml/3.2", type = OperationMethod.class, required = false)
    protected OperationMethod operationMethod;
     ...
     *     
     */
    public void setOperationMethod(OperationMethod value) {
