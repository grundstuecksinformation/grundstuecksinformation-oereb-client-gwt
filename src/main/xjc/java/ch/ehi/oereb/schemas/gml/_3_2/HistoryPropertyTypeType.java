...
public class HistoryPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "AbstractTimeSlice", namespace = "http://www.opengis.net/gml/3.2", type = AbstractTimeSlice.class)
    protected List<JAXBElement<? extends AbstractTimeSliceTypeType>> abstractTimeSlice;
     ...
     * 
     */
    public List<JAXBElement<? extends AbstractTimeSliceTypeType>> getAbstractTimeSlice() {
        if (abstractTimeSlice == null) {
            abstractTimeSlice = new ArrayList<JAXBElement<? extends AbstractTimeSliceTypeType>>();
        }
