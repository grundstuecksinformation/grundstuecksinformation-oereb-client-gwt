...
public enum KnotTypesTypeType {
    ...
    public static KnotTypesTypeType fromValue(String v) {
        for (KnotTypesTypeType c: KnotTypesTypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
