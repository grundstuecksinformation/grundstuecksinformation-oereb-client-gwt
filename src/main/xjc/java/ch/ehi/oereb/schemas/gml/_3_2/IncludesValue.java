...
public class IncludesValue
    extends JAXBElement<AbstractGeneralParameterValuePropertyTypeType>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "includesValue");

    public IncludesValue(AbstractGeneralParameterValuePropertyTypeType value) {
