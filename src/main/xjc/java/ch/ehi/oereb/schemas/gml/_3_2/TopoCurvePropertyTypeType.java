...
public class TopoCurvePropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TopoCurve", namespace = "http://www.opengis.net/gml/3.2", type = TopoCurve.class)
    protected TopoCurve topoCurve;
     ...
     *     
     */
    public void setTopoCurve(TopoCurve value) {
