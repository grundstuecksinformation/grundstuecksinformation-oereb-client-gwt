...
public class TopoVolumePropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TopoVolume", namespace = "http://www.opengis.net/gml/3.2", type = TopoVolume.class)
    protected TopoVolume topoVolume;
     ...
     *     
     */
    public TopoVolume getTopoVolume() {
        return topoVolume;
    }
     ...
     *     
     */
    public void setTopoVolume(TopoVolume value) {
