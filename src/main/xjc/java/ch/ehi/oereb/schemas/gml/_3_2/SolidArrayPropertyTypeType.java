...
public class SolidArrayPropertyTypeType
    implements Serializable
{
    ...
    protected List<JAXBElement<? extends AbstractSolidTypeType>> abstractSolid;
     ...
     * 
     */
    public List<JAXBElement<? extends AbstractSolidTypeType>> getAbstractSolid() {
        if (abstractSolid == null) {
            abstractSolid = new ArrayList<JAXBElement<? extends AbstractSolidTypeType>>();
        }
