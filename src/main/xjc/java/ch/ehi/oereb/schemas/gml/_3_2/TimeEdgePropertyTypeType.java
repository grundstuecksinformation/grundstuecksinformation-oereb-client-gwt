...
public class TimeEdgePropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TimeEdge", namespace = "http://www.opengis.net/gml/3.2", type = TimeEdge.class, required = false)
    protected TimeEdge timeEdge;
     ...
     *     
     */
    public void setTimeEdge(TimeEdge value) {
        this.timeEdge = value;
    }
