...
public class TopoPointPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TopoPoint", namespace = "http://www.opengis.net/gml/3.2", type = TopoPoint.class)
    protected TopoPoint topoPoint;
     ...
     *     
     */
    public void setTopoPoint(TopoPoint value) {
