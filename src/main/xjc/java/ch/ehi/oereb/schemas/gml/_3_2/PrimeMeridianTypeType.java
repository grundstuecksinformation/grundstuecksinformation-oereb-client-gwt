...
public class PrimeMeridianTypeType
    extends IdentifiedObjectTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "greenwichLongitude", namespace = "http://www.opengis.net/gml/3.2", type = GreenwichLongitude.class)
    protected GreenwichLongitude greenwichLongitude;
     ...
     * @return
     *     possible object is
     *     {@link GreenwichLongitude }
     *     
     */
    public GreenwichLongitude getGreenwichLongitude() {
     ...
     *     
     */
    public void setGreenwichLongitude(GreenwichLongitude value) {
