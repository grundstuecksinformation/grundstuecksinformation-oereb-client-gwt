...
public class MultilingualTextType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "LocalisedText", required = true)
    protected List<LocalisedTextType> localisedText;
     ...
     * 
     */
    public List<LocalisedTextType> getLocalisedText() {
        if (localisedText == null) {
            localisedText = new ArrayList<LocalisedTextType>();
        }
