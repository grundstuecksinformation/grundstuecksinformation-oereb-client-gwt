...
@XmlSeeAlso({
    BSplineTypeType.class,
    ClothoidTypeType.class,
    ArcStringTypeType.class,
    ArcByCenterPointTypeType.class,
    LineStringSegmentTypeType.class,
    GeodesicStringTypeType.class,
    OffsetCurveTypeType.class,
    ArcStringByBulgeTypeType.class,
    CubicSplineTypeType.class
})
public abstract class AbstractCurveSegmentTypeType implements Serializable
{
