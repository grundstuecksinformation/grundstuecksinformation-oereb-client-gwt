...
public class AffinePlacementTypeType implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(required = true)
    protected DirectPositionTypeType location;
    @XmlElement(required = true)
    protected List<VectorTypeType> refDirection;
    @XmlElement(required = true)
     ...
     *     
     */
    public DirectPositionTypeType getLocation() {
        return location;
    }
     ...
     *     
     */
    public void setLocation(DirectPositionTypeType value) {
        this.location = value;
    }
     ...
     * 
     */
    public List<VectorTypeType> getRefDirection() {
        if (refDirection == null) {
            refDirection = new ArrayList<VectorTypeType>();
        }
