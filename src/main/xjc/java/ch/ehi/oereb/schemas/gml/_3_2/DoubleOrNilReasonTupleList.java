...
public class DoubleOrNilReasonTupleList
    extends JAXBElement<List<String>>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "doubleOrNilReasonTupleList");

    public DoubleOrNilReasonTupleList(List<String> value) {
