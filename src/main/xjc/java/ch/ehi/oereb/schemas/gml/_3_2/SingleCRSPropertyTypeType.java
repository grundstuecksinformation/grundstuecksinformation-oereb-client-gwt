...
public class SingleCRSPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "AbstractSingleCRS", namespace = "http://www.opengis.net/gml/3.2", type = AbstractSingleCRS.class, required = false)
    protected JAXBElement<? extends AbstractCRSTypeType> abstractSingleCRS;
     ...
     *     
     */
    public JAXBElement<? extends AbstractCRSTypeType> getAbstractSingleCRS() {
     ...
     *     
     */
    public void setAbstractSingleCRS(JAXBElement<? extends AbstractCRSTypeType> value) {
