    ...
    extends JAXBElement<AbstractGeneralParameterValuePropertyTypeType>
{
    ...
    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "usesValue");

    public UsesValue(AbstractGeneralParameterValuePropertyTypeType value) {
