...
public class TemporalCRSPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TemporalCRS", namespace = "http://www.opengis.net/gml/3.2", type = TemporalCRS.class, required = false)
     ...
     *     
     */
    public void setTemporalCRS(TemporalCRS value) {
