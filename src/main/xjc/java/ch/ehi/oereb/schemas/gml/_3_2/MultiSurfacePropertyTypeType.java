...
public class MultiSurfacePropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "MultiSurface", namespace = "http://www.opengis.net/gml/3.2", type = MultiSurface.class, required = false)
