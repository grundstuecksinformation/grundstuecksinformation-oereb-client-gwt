...
public class TimeCalendarPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "TimeCalendar", namespace = "http://www.opengis.net/gml/3.2", type = TimeCalendar.class, required = false)
    protected TimeCalendar timeCalendar;
     ...
     *     
     */
    public void setTimeCalendar(TimeCalendar value) {
