...
@XmlSeeAlso({
    TimeEdgeTypeType.class,
    TimeNodeTypeType.class
})
public abstract class AbstractTimeTopologyPrimitiveTypeType
    extends AbstractTimePrimitiveTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    protected ReferenceTypeType complex;
     ...
     *     
     */
    public ReferenceTypeType getComplex() {
        return complex;
    }
     ...
     *     
     */
    public void setComplex(ReferenceTypeType value) {
        this.complex = value;
    }
