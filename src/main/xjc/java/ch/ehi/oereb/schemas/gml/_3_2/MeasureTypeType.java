...
@XmlSeeAlso({
    LengthTypeType.class,
    AngleTypeType.class,
    ch.ehi.oereb.schemas.gml._3_2.Quantity.Type.class,
    ScaleTypeType.class,
    AreaTypeType.class,
    GridLengthTypeType.class,
    SpeedTypeType.class,
    TimeTypeType.class,
    VolumeTypeType.class
})
public class MeasureTypeType implements Serializable
{
