...
@XmlSeeAlso({
    FeatureCollectionTypeType.class
})
public abstract class AbstractFeatureCollectionTypeType
    extends AbstractFeatureTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "featureMember", namespace = "http://www.opengis.net/gml/3.2", type = FeatureMember.class, required = false)
    protected List<FeatureMember> featureMember;
    @XmlElementRef(name = "featureMembers", namespace = "http://www.opengis.net/gml/3.2", type = FeatureMembers.class, required = false)
    protected FeatureMembers featureMembers;
     ...
     *     
     */
    public void setFeatureMembers(FeatureMembers value) {
