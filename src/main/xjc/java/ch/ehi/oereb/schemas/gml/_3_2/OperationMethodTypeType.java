...
public class OperationMethodTypeType
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "formula", namespace = "http://www.opengis.net/gml/3.2", type = Formula.class, required = false)
    protected JAXBElement<CodeTypeType> formula;
    @XmlElementRef(name = "sourceDimensions", namespace = "http://www.opengis.net/gml/3.2", type = SourceDimensions.class, required = false)
    protected SourceDimensions sourceDimensions;
    @XmlElementRef(name = "targetDimensions", namespace = "http://www.opengis.net/gml/3.2", type = TargetDimensions.class, required = false)
    protected TargetDimensions targetDimensions;
    @XmlElementRef(name = "parameter", namespace = "http://www.opengis.net/gml/3.2", type = Parameter.class, required = false)
     ...
     *     
     */
    public JAXBElement<CodeTypeType> getFormula() {
        return formula;
    }
     ...
     *     
     */
    public void setFormula(JAXBElement<CodeTypeType> value) {
        this.formula = value;
    }
     ...
     *     
     */
    public SourceDimensions getSourceDimensions() {
     ...
     *     
     */
    public void setSourceDimensions(SourceDimensions value) {
     ...
     *     
     */
    public void setTargetDimensions(TargetDimensions value) {
