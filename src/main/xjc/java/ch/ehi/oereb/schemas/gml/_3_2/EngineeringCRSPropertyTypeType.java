...
public class EngineeringCRSPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "EngineeringCRS", namespace = "http://www.opengis.net/gml/3.2", type = EngineeringCRS.class, required = false)
    protected EngineeringCRS engineeringCRS;
     ...
     *     
     */
    public EngineeringCRS getEngineeringCRS() {
     ...
     *     
     */
    public void setEngineeringCRS(EngineeringCRS value) {
