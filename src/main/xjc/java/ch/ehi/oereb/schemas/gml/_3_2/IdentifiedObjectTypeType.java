...
@XmlSeeAlso({
    OperationMethodTypeType.class,
    PrimeMeridianTypeType.class,
    CoordinateSystemAxisTypeType.class,
    AbstractGeneralOperationParameterTypeType.class,
    EllipsoidTypeType.class,
    AbstractCRSTypeType.class,
    AbstractCoordinateOperationTypeType.class,
    AbstractCoordinateSystemTypeType.class,
    AbstractDatumTypeType.class
})
public abstract class IdentifiedObjectTypeType
