...
public class RealizationEpoch
    extends JAXBElement<XMLGregorianCalendar>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "realizationEpoch");

    public RealizationEpoch(XMLGregorianCalendar value) {
