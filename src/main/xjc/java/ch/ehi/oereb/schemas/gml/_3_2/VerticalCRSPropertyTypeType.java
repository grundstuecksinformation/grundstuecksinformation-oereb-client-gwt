...
public class VerticalCRSPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "VerticalCRS", namespace = "http://www.opengis.net/gml/3.2", type = VerticalCRS.class, required = false)
     ...
     *     
     */
    public void setVerticalCRS(VerticalCRS value) {
