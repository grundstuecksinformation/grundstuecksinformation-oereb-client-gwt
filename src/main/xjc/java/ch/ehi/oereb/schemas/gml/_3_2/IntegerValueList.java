...
public class IntegerValueList
    extends JAXBElement<List<BigInteger>>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "integerValueList");

    public IntegerValueList(List<BigInteger> value) {
