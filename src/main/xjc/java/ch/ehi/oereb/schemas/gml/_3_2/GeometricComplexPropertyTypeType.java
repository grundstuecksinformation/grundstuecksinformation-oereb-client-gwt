...
public class GeometricComplexPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "GeometricComplex", namespace = "http://www.opengis.net/gml/3.2", type = GeometricComplex.class, required = false)
    protected GeometricComplex geometricComplex;
    @XmlElementRef(name = "CompositeCurve", namespace = "http://www.opengis.net/gml/3.2", type = CompositeCurve.class, required = false)
    protected CompositeCurve compositeCurve;
    @XmlElementRef(name = "CompositeSurface", namespace = "http://www.opengis.net/gml/3.2", type = CompositeSurface.class, required = false)
    protected CompositeSurface compositeSurface;
    @XmlElementRef(name = "CompositeSolid", namespace = "http://www.opengis.net/gml/3.2", type = CompositeSolid.class, required = false)
    protected CompositeSolid compositeSolid;
     ...
     *     
     */
    public void setGeometricComplex(GeometricComplex value) {
     ...
     *     
     */
    public void setCompositeCurve(CompositeCurve value) {
     ...
     *     
     */
    public void setCompositeSurface(CompositeSurface value) {
     ...
     *     
     */
    public void setCompositeSolid(CompositeSolid value) {
