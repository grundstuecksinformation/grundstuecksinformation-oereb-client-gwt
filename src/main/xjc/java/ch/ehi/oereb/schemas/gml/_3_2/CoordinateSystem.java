    ...
    extends JAXBElement<CoordinateSystemPropertyTypeType>
{
    ...
    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "coordinateSystem");

    public CoordinateSystem(CoordinateSystemPropertyTypeType value) {
