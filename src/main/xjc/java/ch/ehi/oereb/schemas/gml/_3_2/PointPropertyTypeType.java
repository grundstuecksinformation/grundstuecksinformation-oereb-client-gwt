...
public class PointPropertyTypeType implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "Point", namespace = "http://www.opengis.net/gml/3.2", type = Point.class, required = false)
