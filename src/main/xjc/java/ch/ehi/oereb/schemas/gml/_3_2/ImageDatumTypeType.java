...
public class ImageDatumTypeType
    extends AbstractDatumTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "pixelInCell", namespace = "http://www.opengis.net/gml/3.2", type = PixelInCell.class)
    protected PixelInCell pixelInCell;
     ...
     *     
     */
    public void setPixelInCell(PixelInCell value) {
