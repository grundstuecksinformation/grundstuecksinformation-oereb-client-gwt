...
@XmlSeeAlso({
    GridTypeType.class,
    GeometricComplexTypeType.class,
    AbstractGeometricAggregateTypeType.class,
    AbstractGeometricPrimitiveTypeType.class
})
public abstract class AbstractGeometryTypeType
