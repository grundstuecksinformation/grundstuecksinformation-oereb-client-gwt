...
public class SurfaceTypeType
    extends AbstractSurfaceTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "patches", namespace = "http://www.opengis.net/gml/3.2", type = Patches.class)
    protected JAXBElement<SurfacePatchArrayPropertyTypeType> patches;
     ...
     *     
     */
    public JAXBElement<SurfacePatchArrayPropertyTypeType> getPatches() {
        return patches;
    }
     ...
     *     
     */
    public void setPatches(JAXBElement<SurfacePatchArrayPropertyTypeType> value) {
        this.patches = value;
    }
