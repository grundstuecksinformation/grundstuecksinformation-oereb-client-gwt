...
public class SolidPropertyTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "AbstractSolid", namespace = "http://www.opengis.net/gml/3.2", type = AbstractSolid.class, required = false)
    protected JAXBElement<? extends AbstractSolidTypeType> abstractSolid;
     ...
     *     
     */
    public JAXBElement<? extends AbstractSolidTypeType> getAbstractSolid() {
     ...
     *     
     */
    public void setAbstractSolid(JAXBElement<? extends AbstractSolidTypeType> value) {
