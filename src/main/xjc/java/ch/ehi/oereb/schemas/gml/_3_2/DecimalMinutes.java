...
public class DecimalMinutes
    extends JAXBElement<BigDecimal>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "decimalMinutes");

    public DecimalMinutes(BigDecimal value) {
