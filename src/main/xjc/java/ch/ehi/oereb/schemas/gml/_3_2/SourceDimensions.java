...
public class SourceDimensions
    extends JAXBElement<BigInteger>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "sourceDimensions");

    public SourceDimensions(BigInteger value) {
