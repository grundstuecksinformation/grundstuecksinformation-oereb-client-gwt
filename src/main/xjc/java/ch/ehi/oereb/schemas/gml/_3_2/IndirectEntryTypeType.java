...
public class IndirectEntryTypeType implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "DefinitionProxy", namespace = "http://www.opengis.net/gml/3.2", type = DefinitionProxy.class)
