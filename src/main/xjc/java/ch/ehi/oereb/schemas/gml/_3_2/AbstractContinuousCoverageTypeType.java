...
public abstract class AbstractContinuousCoverageTypeType
    extends AbstractCoverageTypeType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElementRef(name = "coverageFunction", namespace = "http://www.opengis.net/gml/3.2", type = CoverageFunction.class, required = false)
    protected CoverageFunction coverageFunction;
     ...
     *     
     */
    public void setCoverageFunction(CoverageFunction value) {
