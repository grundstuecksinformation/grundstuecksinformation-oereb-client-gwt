...
@XmlSeeAlso({
    PolygonPatchTypeType.class,
    TriangleTypeType.class,
    RectangleTypeType.class,
    AbstractParametricCurveSurfaceTypeType.class
})
public abstract class AbstractSurfacePatchTypeType implements Serializable
{
