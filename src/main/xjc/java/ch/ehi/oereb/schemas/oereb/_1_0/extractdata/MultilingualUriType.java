...
public class MultilingualUriType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "LocalisedText", required = true)
    protected List<LocalisedUriType> localisedText;
     ...
     * {@link LocalisedUriType }
     * 
     * 
     */
    public List<LocalisedUriType> getLocalisedText() {
        if (localisedText == null) {
            localisedText = new ArrayList<LocalisedUriType>();
        }
